...
export type ProjectMediaActions = Pick<ProjectSlice,
  | "setMissingMediaIds"
  | "loadProject"
  | "addMedia"
...
export type ProjectTimelineActions = Pick<ProjectSlice,
  | "addClip"
  | "removeClip"
  | "moveClip"
  | "moveClipsBatch"
...
export type ProjectClipPropertyActions = Pick<ProjectSlice,
  | "updateClipTransform"
